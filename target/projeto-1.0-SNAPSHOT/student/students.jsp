                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link active" href="../home.jsp">
                                    <img src="../icons/house.svg" alt="" width="32" height="32" title="house">
                                    Página Inicial <span class="sr-only">(current)</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="../student/create.jsp">
                                    <img src="../icons/check-box.svg" alt="" width="32" height="32" title="check-box">
                                    Cadastrar Aluno
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../student/list.jsp">
                                    <img src="../icons/file-text.svg" alt="" width="32" height="32" title="file-text">
                                    Alunos Cadastrados
                                </a>
                            </li>
                        </ul>                      
